...
export class SpecialGiftComponent {
  gifts: Gift[] = [
    {
      img: './imgs/specialGift/specialGift1.png',
      title: 'Start $10.99',
    ...
    {
      imgs: [
        './imgs/specialGift/specialGift2.1.png',
        './imgs/specialGift/specialGift2.2.png',
        './imgs/specialGift/specialGift2.3.png',
        './imgs/specialGift/specialGift2.4.png',
      ],
    ...
    {
      img: './imgs/specialGift/specialGift3.png',
      title: 'Gifts Box',
      desc: 'Awesome Gifts Box Collectons',
      btnText: 'Shop Now',
    },
    {
      img: './imgs/specialGift/specialGift4.png',
      title: 'Occasion Gifts',
      desc: 'Best Occasion Gifts Collections',
      btnText: 'Discover Now',
    },
    {
      img: './imgs/specialGift/specialGift5.png',
      title: 'Occasion Gifts',
